package com.taskiran.backend.config;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/cars/{id}").permitAll()
                        .requestMatchers(HttpMethod.DELETE, "/api/v1/cars/{id}").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/cars/**/{id}").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/v1/cars/{id}").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/api/v1/cars/{id}").permitAll()
